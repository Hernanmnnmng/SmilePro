                ...
                @else
                    <div class="flex items-center gap-4">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-sm font-medium text-white bg-gray-800 dark:bg-gray-200 dark:text-gray-800 px-4 py-2 rounded-md hover:bg-gray-700 dark:hover:bg-gray-300">
                                {{ __('Register') }}
                            </a>
                        @endif
                    </div>
